...
def dashboard_profs(request):
    ...
    # CORRECTION ICI : mettre le chemin complet du dossier templates
    return render(request, 'internship_projet_gestion_profs/dashboard.html', {'offres': lesOffres})
...
def valider_offre(request, offre_id):
    ...
    return render(request, 'internship_projet_gestion_profs/editer_offre.html', {'form': form, 'offre': offre})
